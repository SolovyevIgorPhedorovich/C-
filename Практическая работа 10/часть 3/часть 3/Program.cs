...
namespace часть_3
{
    ...
    public class Person : IRandomInit, IComparable, ICloneable
    {
        ...
        public object Clone()
        {
            return new Person(this.Name, this.Surname, this.Gender, this.Age);
        }
    }
    ...
    internal class Program
    {
        ...
        {
            IRandomInit[] i = { new employee("Tom", "Helt", "M", 0), new ingener("Devid", "Pload", "M", 0), new ingener("Adam", "Lopepr", "M", 30), new worker("Daiv", "Loker", "M", 30), new worker("Emver", "Hoeten", "W", 23), new Direcror() };
            foreach (var v in i)
            {
                v.RandomInit();
